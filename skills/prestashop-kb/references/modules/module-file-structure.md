---
source_url: https://devdocs.prestashop-project.org/9/modules/creation/module-file-structure/
ps_version: [8, 9]
ingested: 2026-04-18
section: Modules > Folder structure & config.xml
topic: modules
tags: [prestashop, modules, file-structure, config-xml, manifest]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/modules/creation/module-file-structure.md "Improve this page") [How](/9/contribute/documentation/how)
...
The `config` folder is the place where configuration files are stored. In particular, [Routes](/9/modules/concepts/controllers/admin-controllers/#how-to-map-an-action-of-your-controller-to-a-uri) and [Services](https://devdocs.prestashop-project.org/9/modules/concepts/services/).
...
[Read more about Controllers →](https://devdocs.prestashop-project.org/9/modules/concepts/controllers/)
...
[Read more about Overrides →](https://devdocs.prestashop-project.org/9/modules/concepts/overrides/)
...
[Read more about Translation →](https://devdocs.prestashop-project.org/9/modules/creation/module-translation/)

### upgrade/ folder

The `upgrade` folder contains upgrade scripts to be executed when updating the module from a previous version.

[Read more about the Upgrade feature →](https://devdocs.prestashop-project.org/9/modules/creation/enabling-auto-update/)

### vendor/ folder

The `vendor` folder usually contains libraries imported through [Composer](https://devdocs.prestashop-project.org/9/modules/concepts/composer/) as well as its autoloader. This folder is optional.
...
Since 1.7.3 you can redefine back office views by placing files in this folder. This is covered in [Overriding back office views](https://devdocs.prestashop-project.org/9/modules/concepts/templating/admin-views/).

[Read more about Templating →](https://devdocs.prestashop-project.org/9/modules/concepts/templating/)
...
- [[../../modules/README|Panda module fiches template]]

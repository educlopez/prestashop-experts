---
source_url: https://smarty-php.github.io/smarty/stable/designers/language-variables/language-assigned-variables/
topic: smarty
subtopic: variables
ingested: 2026-04-18
...
Properties of [objects](../../../api/variables/objects/) assigned from PHP can be referenced by specifying the property name after the `->` symbol.

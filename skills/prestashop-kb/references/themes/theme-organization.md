---
source_url: https://devdocs.prestashop-project.org/9/themes/getting-started/theme-organization/
ps_version: [8, 9]
ingested: 2026-04-18
section: Themes > Theme Organization (directory structure)
topic: themes
tags: [prestashop, themes, directory-structure, classic]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/themes/getting-started/theme-organization.md "Improve this page") [How](/9/contribute/documentation/how)
...
There is a list of files that need to exists, even if they’re empty. Please see dedicated documentation to know [what makes a theme valid](/9/themes/distribution/testing/).
...
Read more about [assets management](/9/themes/getting-started/asset-management/).

---
source_url: https://devdocs.prestashop-project.org/9/modules/concepts/widgets/
ps_version: [8, 9]
ingested: 2026-04-18
section: Modules > Widgets
topic: modules
tags: [prestashop, modules, widgets, hooks, smarty]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/modules/concepts/widgets.md "Improve this page") [How](/9/contribute/documentation/how)
...
- the core to fallback on it if a registered hook is called but its method `hook<hook_name>()` does not exist.
...
Before calling a module for widgets, the core must be sure your module has this feature available. This can be done by implementing the interface `PrestaShop\PrestaShop\Core\Module\WidgetInterface` ([Source code](https://github.com/PrestaShop/PrestaShop/blob/9.1.x/src/Core/Module/WidgetInterface.php)).
...
The method `renderWidget()` is the entrypoint for the core in order to get the generated view (fetch smarty template). The method `getWidgetVariables()` returns the variables you want to assign to smarty.
...
![](../img/widget-example-hooks.png)

Using widget from hooks

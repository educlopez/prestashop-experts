---
source_url: https://devdocs.prestashop-project.org/9/modules/introduction/
ps_version: [8, 9]
ingested: 2026-04-18
section: Modules > Introduction
topic: modules
tags: [prestashop, modules, overview]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/modules/introduction.md "Improve this page") [How](/9/contribute/documentation/how)
...
- Facilitate [interactions between the shop and external services](/9/modules/creation/external-services/).
...
Some native modules have had their names changed in PrestaShop 1.7. [See the full list here](https://devdocs.prestashop-project.org/9/development/native-modules/#module-name-changes-since-16).

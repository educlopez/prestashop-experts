---
source_url: https://devdocs.prestashop-project.org/9/modules/creation/tutorial/
ps_version: [8, 9]
ingested: 2026-04-18
section: Modules > Creation Tutorial (first module)
topic: modules
tags: [prestashop, modules, tutorial, creation]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/modules/creation/tutorial.md "Improve this page") [How](/9/contribute/documentation/how)

Before you start writing code for your PrestaShop module, we recommend reading PrestaShop’s [Coding standards](https://devdocs.prestashop-project.org/9/development/coding-standards/). Configuring your IDE hints or using [automated tools](https://github.com/PrestaShop/php-dev-tools) can help you make sure you follow the project’s standards properly.
...
Technical names can only accept lower case alphanumeric characters (`[a-z0-9]`). [Although accepted, we strongly discourage using underscores because they don’t work with translation domains](https://devdocs.prestashop-project.org/9/modules/creation/module-translation/new-system/#translation-domain).
...
- The `tab` attribute contains the section that shall contain this module in the Module Manager section in the Back office (see [list of available sections](https://devdocs.prestashop-project.org/9/modules/concepts/module-class/#tab)). We choose `front_office_features` because our module will mostly have an impact on the front-end.
...
- Check that the [Multistore feature](https://devdocs.prestashop-project.org/9/development/multistore/) is enabled, and if so, set the current context to all shops on this installation of PrestaShop.
...
You can read more about this component in [Legacy Configuration object](https://devdocs.prestashop-project.org/9/development/components/configuration/backward-compatibility/) and [Configuration storage](https://devdocs.prestashop-project.org/9/development/components/configuration/).
...
The Shop Context is explained in more details in the [Multistore documentation](https://devdocs.prestashop-project.org/9/development/multistore/).
...
For more informations, please read [the reference of the ModuleCommand](https://devdocs.prestashop-project.org/9/development/components/console/prestashop-module/)
...
- [[module-file-structure|Module folder structure]]

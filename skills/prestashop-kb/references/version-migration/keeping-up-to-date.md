---
source_url: https://devdocs.prestashop-project.org/9/basics/keeping-up-to-date/
ps_version: [9]
ingested: 2026-04-18
section: Version Migration > Update vs Migration overview
topic: migration
tags: [prestashop, migration, upgrade, update, 8-to-9]
---

[Improve this page](https://github.com/PrestaShop/docs/edit/9.x/basics/keeping-up-to-date/_index.md "Improve this page") [How](/9/contribute/documentation/how)
...
For a detailed step-by-step guide, refer to the official documentation for the [Update Assistant module](/9/basics/keeping-up-to-date/update/).
...
For a detailed step-by-step guide, refer to the [Migration Documentation](/9/basics/keeping-up-to-date/migration/).

## Read more

- [How to update PrestaShop](/9/basics/keeping-up-to-date/update/)
- [How to backup PrestaShop](/9/basics/keeping-up-to-date/backup/)
- [How to migrate to PrestaShop 8](/9/basics/keeping-up-to-date/migration/)

---
source_url: https://smarty-php.github.io/smarty/stable/designers/language-basic-syntax/language-syntax-operators/
topic: smarty
...
| is in |  | $a is in $b | exists in array | in\_array($a, $b) |
| is \[not\] in |  | $a is not in $b | does not exist in array | !in\_array($a, $b) |
| matches |  | $a matches $b | regex pattern match | preg\_match($b, $a) |

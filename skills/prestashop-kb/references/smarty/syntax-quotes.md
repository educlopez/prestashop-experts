---
source_url: https://smarty-php.github.io/smarty/stable/designers/language-basic-syntax/language-syntax-quotes/
topic: smarty
subtopic: variables
ingested: 2026-04-18
...
- Smarty will recognize [assigned](../../../programmers/api-functions/api-assign/) [variables](../language-syntax-variables/) embedded in "double quotes" so long as the variable name contains only numbers, letters and under\_scores. See [naming](https://www.php.net/language.variables) for more detail.
...
See also [`escape`](../../language-modifiers/language-modifier-escape/).
